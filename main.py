...
Оставляет вход в аккаунт (Telethon). Ищет новичков с дешёвыми лотами:
рейтинг 1, ровно 1 NFT, цена у флора, без флипперов.
"""
...
class MammothApp:
    ...
    async def start(self) -> None:
        ...
        LOGGER.info(
            "лог-группа %s | новичок = ур.1 · 1 NFT · дешёвый у флора · без флипперов",
